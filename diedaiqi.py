...
# 这些可以直接作用于for循环的对象统称为可迭代对象：Iterable  根据boolean值看是否可以迭代
...
from collections.abc import Iterator  #3.8版本开始不支持from collection；支持collection.abc
...
# 凡是可以next()的，都是Iterator，它们表示一个惰性计算的序列
